...
create_account_screen = CreateAccountScreen()  # Initialize the CreateAccountScreen
...
def update():
    global player_team_screen, roster_screen, create_account_screen, selected_team, teamID, front_office
